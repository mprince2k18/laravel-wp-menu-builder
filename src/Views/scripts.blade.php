...
<script type="text/javascript" src="{{asset('vendor/mprince-menu/scripts.js')}}"></script>
<script type="text/javascript" src="{{asset('vendor/mprince-menu/scripts2.js')}}"></script>
<script type="text/javascript" src="{{asset('vendor/mprince-menu/menu.js')}}"></script>